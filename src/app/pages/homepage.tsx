...
export default function HomePage() {
  return (
    <div className="bg-bg-dark hide-scrollbar hide-scrollbar  flex h-[400vh] w-full flex-col items-center justify-start overflow-x-hidden transition-colors duration-500">
      ...
      <div className="z-99 absolute left-0 top-0 h-[400vh] w-full gap-[40px] px-[32px] py-[24px]">
        <NavBar />
