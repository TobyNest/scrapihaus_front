      ...
      <div className="flex h-full w-full flex-col items-center justify-center gap-16">
        ...
        <div className="h-3/4 w-[40%] rounded-md p-8 shadow-[0_0_30px_0_rgba(0,0,0,0.2)]">
          ...
          <div className="w-600 mt-12 flex items-center justify-center">
            <div className="group mt-8 flex h-14 w-60 cursor-pointer items-center justify-center rounded-2xl bg-black text-xl font-bold text-white transition-all duration-150 ease-in-out">
              <div>Pesquisar</div>
